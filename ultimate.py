...
class ChatWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        self.text_view.add_css_class("text-view")
            ...
            try:
                ...
                for chunk in response.iter_lines():
                    if chunk:
                        ...
                        ai_response += part
                        GLib.idle_add(self.update_ai_response, part)
                GLib.idle_add(self.finalize_ai_response, ai_response)
